...
import sampleImage from "../../assets/testimonials-3.jpg"; 

const SectionImageContainerThree = () => {
  return (
    <>
      <div className="container-fluid text-center">
        <div className="row">
          ...
          <div className="col-lg-7 col-md-12 col-sm-12 col-12 d-flex justify-content-center align-items-center">
            <img src={sampleImage} alt="Sample" height="50%" width='100%' /> 
          </div>
        </div>
      </div>
    </>
...
export default SectionImageContainerThree;
